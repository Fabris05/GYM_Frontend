                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        <div className="lg:col-span-8 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-3xl p-12 flex flex-col justify-center">
                            ...
                            <p className="text-xl md:text-2xl text-black/80 mb-8 max-w-2xl">
                                Únete a PointFit y descubre el gimnasio que
                                cambiará tu vida. Entrenamientos personalizados,
                                equipamiento de última generación.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                <Link
                                    href="#planes"
                                    className="bg-white border-2 border-black text-black hover:bg-black hover:text-yellow-500 font-bold text-lg px-8 rounded-full flex items-center py-2"
                                >
                                    Ver Planes
                                </Link>
                            </div>
